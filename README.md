...
| Primary focus | geographic helpers, location utilities, typed coordinates |
...
- This repo currently publishes `@platform/geo` as the legacy compatibility package id while the migration to `@gutu/geo` is completed.
